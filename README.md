...
|_|  |_|\__, | .__/ \___|_|    \/     |____/ \__,_|\___|_|\_\\__,_| .__/   \____/ \__|_|_|_|\__|\__, |
         __/ | |                                                  | |                            __/ |
        |___/|_|          Mike Galvin   https://gal.vin           |_|      Version 21.06.02     |___/
```
...
| -SzThreads | Instructs 7-Zip to use multiple threads. | -mmt4 |
| -SzComp | Instructs 7-Zip to use different levels of compression. | -mx1, -mx9 |
| -SzType | Instructs 7-Zip to use a different archive type. | -t7z, -tzip, -ttar |
| -SzSplit | Instructs 7-Zip to split the files. | -v100m, -v2g |
...
``` txt
Hyper-V-Backup.ps1 -BackupTo \\nas\vms -List C:\scripts\vms.txt -Wd E:\temp -NoPerms -Keep 30 -Compress -Sz -SzThreads -mmt8 -SzComp -mx5 -SzType -t7z -SzSplit -v2g -L C:\scripts\logs -Subject 'Server: Hyper-V Backup' -SendTo me@contoso.com -From hyperv@contoso.com -Smtp smtp.outlook.com -User user -Pwd C:\foo\pwd.txt -UseSsl
```
